...
cookies = "anonymid=k0hyz431-7bnj7b; depovince=BJ; _r01_=1; JSESSIONID=abcxYogd1OjytaetKiQ0w; "\
          ...
          "xnsid=2ac9a5d8; loginfrom=syshome; ch_id=10016; wp_fold=0 "
# 把字符串转化为列表
...
# 保存页面
with open("人人网3.html", "w", encoding="utf-8") as f:
